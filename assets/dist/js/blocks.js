...
/* harmony import */ var _babel_runtime_helpers_objectDestructuringEmpty__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @babel/runtime/helpers/objectDestructuringEmpty */ "./node_modules/@babel/runtime/helpers/objectDestructuringEmpty.js");
/* harmony import */ var _babel_runtime_helpers_objectDestructuringEmpty__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_objectDestructuringEmpty__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _Connections_Directory_components__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @Connections-Directory/components */ "./includes/blocks/components/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./style.scss */ "./includes/blocks/carousel/style.scss");
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(Carousel, _Component);
  ...
  function Carousel(props) {
    ...
    // super( ...arguments );
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(Carousel).call(this, props));
    console.log(_this.props.name, ": constructor()"); // console.log( 'constructor()::arguments ', arguments );
    // console.log( 'constructor()::props ', props );

    console.log('constructor()::this.props ', _this.props);
    var _this$props = _this.props,
        _this$props$attribute = _this$props.attributes,
        blockId = _this$props$attribute.blockId,
        blocks = _this$props$attribute.blocks,
        clientId = _this$props.clientId,
        setAttributes = _this$props.setAttributes;
    _this.getIndex = _this.getIndex.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Carousel, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$props2 = this.props,
          ...
          blocks = _this$props2$attribut.blocks,
          blockId = _this$props2$attribut.blockId,
    ...
    value: function fetchAPI(query) {
      var path = addQueryArgs(ENDPOINT, _objectSpread({}, query, {
        context: 'edit'
      }));
    ...
    value: function findIndex(id, blocks) {
      ...
      var index = Object(lodash__WEBPACK_IMPORTED_MODULE_11__["findIndex"])(blocks, function (o) {
        console.log('findIndex::o ', o);
        return !Object(lodash__WEBPACK_IMPORTED_MODULE_11__["isUndefined"])(o) && o.blockId === id;
      });
    ...
    value: function getAttribute(key) {
      ...
      var _this$props$attribute2 = this.props.attributes,
          blocks = _this$props$attribute2.blocks,
          blockId = _this$props$attribute2.blockId;
      var index = this.getIndex(); // if ( -1 === index || isUndefined( blocks[ index ][ key ] ) ) {

      if (-1 === index || !Object(lodash__WEBPACK_IMPORTED_MODULE_11__["has"])(blocks, [index, key])) {
        return defaultValue;
      } else {
    ...
    value: function render() {
      ...
      if (!hasEntries) {
        return wp.element.createElement(Fragment, null, wp.element.createElement("div", null, this.state.isLoading ? wp.element.createElement("p", null, __('Loading...', 'connections'), " ", wp.element.createElement(Spinner, null)) : wp.element.createElement("p", null, __('No directory entries found.', 'connections'))));
      }
      ...
      var slides = entries.map(function (entry, i) {
        return wp.element.createElement("div", {
          key: i
        }, wp.element.createElement("h3", null, entry.name.rendered), wp.element.createElement("div", null, "Block ID: ", blockId));
      });
      return wp.element.createElement(Fragment, null, wp.element.createElement(InspectorControls, null, wp.element.createElement(PanelBody, {
      ...
      }, wp.element.createElement("p", null, __('Choose the categories to exclude from the entry list.', 'connections'))), wp.element.createElement(_Connections_Directory_components__WEBPACK_IMPORTED_MODULE_12__["HierarchicalTermSelector"], {
        taxonomy: "category",
      ...
      })), wp.element.createElement(_Connections_Directory_components__WEBPACK_IMPORTED_MODULE_12__["RangeControl"], {
      ...
      }), imageShape === 'square' && wp.element.createElement(_Connections_Directory_components__WEBPACK_IMPORTED_MODULE_12__["RangeControl"], {
        ...
        className: "slick-slider-section"
      }, wp.element.createElement(react_slick__WEBPACK_IMPORTED_MODULE_8___default.a, settings, slides)));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (compose([// withDispatch( ( dispatch, { value } ) => {
//
// 	return {
// 		queryEntries() {
//
...
var FilterTagSelector =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(FilterTagSelector, _Component);
  ...
  function FilterTagSelector() {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(FilterTagSelector).apply(this, arguments));
    _this.unescapeTerm = _this.unescapeTerm.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this));
    _this.unescapeTerms = _this.unescapeTerms.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this));
    ...
    _this.searchTerms = Object(lodash__WEBPACK_IMPORTED_MODULE_7__["throttle"])(_this.searchTerms.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)), 300);
    _this.state = {
      loading: false,
      availableTerms: [],
      selectedTerms: []
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_7___default()(HierarchicalTermSelector, _Component);
  ...
  function HierarchicalTermSelector() {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(HierarchicalTermSelector).apply(this, arguments));
    ...
    value: function renderTerms(renderedTerms) {
      ...
      return renderedTerms.map(function (term) {
        ...
        return wp.element.createElement("div", {
          ...
          htmlFor: id
        }, Object(lodash__WEBPACK_IMPORTED_MODULE_8__["unescape"])(term.name)), !!term.children.length && wp.element.createElement("div", {
...
/*!*********************************************!*\
  !*** ./includes/blocks/components/index.js ***!
  \*********************************************/
/*! exports provided: FilterTagSelector, HierarchicalTermSelector, PageSelect, RangeControl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
registerStore('connections-directory/categories', {
  ...
  resolvers: {
    getCategories:
    /*#__PURE__*/
    regeneratorRuntime.mark(function getCategories() {
      var query,
          terms,
          _args = arguments;
...
var store = registerStore('connections-directory/entries', {
  ...
  resolvers: {
    getEntityRecords:
    /*#__PURE__*/
    regeneratorRuntime.mark(function getEntityRecords() {
      var query,
          path,
          entities,
          _args = arguments;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              path = addQueryArgs(ENDPOINT, _objectSpread({}, query, {
                context: 'edit'
              }));
              _context.next = 4;
...
/*!*************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/slick-carousel/slick/slick-theme.css ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../css-loader!./slick-theme.css */ "./node_modules/css-loader/index.js!./node_modules/slick-carousel/slick/slick-theme.css");
