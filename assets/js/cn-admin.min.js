...
},remove:function(d){var c=d.attr("data-token");var e=d.attr("data-type");var f="#"+e+"-row-"+c;b(f).slideUp().remove("fast");},add_meta:function(){var e=b("#list-table").find("tbody tr:last-child");
