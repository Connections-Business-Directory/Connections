...
e.isValid()?d[b].fitBounds(e):d[b].fitWorld()})}})});a.cnAppear("#"+m);k++};a("map-block").each(function(){a(this).mapBlock({})});a.force_appear()});
...
p.scrollTop(),e=b.offset(),g=e.left;e=e.top;return e+b.height()>=d&&e-(b.data("appear-top-offset")||0)<=d+p.height()&&g+b.width()>=c&&g-(b.data("appear-left-offset")||0)<=c+p.width()?!0:!1}});a.fn.extend({appear:function(b,c){a.cnAppear(this,c);return this}});a.extend({cnAppear:function(d,e){var l=a.extend({},t,e||{});if(!c){var h=function(){m||(m=!0,setTimeout(k,l.interval))};a(window).on("scroll",h).on("resize",h).on("click",h);c=!0}l.force_process&&setTimeout(k,l.interval);g.push(d);b.push()},
force_appear:function(){return c?(k(),!0):!1}})})(jQuery);