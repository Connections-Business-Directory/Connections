...
cnWidgets = {
	...
	init : function() {
		...
		var widgets = $('div.widgets-sortables');
		...
		/*$('input.widget-control-save').live('click', function(){
			cnWidgets.save( $(this).closest('div.widget'), 0, 1, 0 );
			return false;
		});

		$('a.widget-control-remove').live('click', function(){
			cnWidgets.save( $(this).closest('div.widget'), 1, 1, 0 );
			return false;
		});*/

		/*$('a.widget-control-close').live('click', function(){
			cnWidgets.close( $(this).closest('div.widget') );
			return false;
		});*/

		/*sidebars.children('.widget').each(function() {
			cnWidgets.appendTitle(this);
		...
		widgets.sortable({
			...
			stop: function(e,ui) {
				...
				/*if ( ui.item.hasClass('deleting') ) {
					cnWidgets.save( ui.item, 1, 0, 1 ); // delete widget
					ui.item.remove();
					return;
				}*/
				...
				/*if ( add ) {
					...
					cnWidgets.save( ui.item, 0, 0, 1 );
					ui.item.find('input.add_new').val('');
					ui.item.find('a.widget-action').click();
					return;
				}*/
				/*cnWidgets.saveOrder(sb);*/
			},
...
$(document).ready(function($){ cnWidgets.init(); });
