<?php
/**
 * Get, validate, and validate HTTP_HOST variable.
 *
 * @since 10.4.8
 *
 * @category   WordPress\Plugin
 * @package    Connections Business Directory
 * @subpackage Connections\Request\Server HTTP_HOST
 ...
 */
class Server_HTTP_Host extends Server {
