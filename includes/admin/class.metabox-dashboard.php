...
class cnDashboardMetabox {
	...
	public static function links() {
		...
		<div class="one-third">
			<p class="center">
				<a class="cn-button cn-button-large cn-background-green cn-button-full" href="http://connections-pro.com/documentation/plugin/"><span><?php _e( 'Documentation', 'connections' ); ?></span></a>
			</p>
		</div>
		...
		<div class="one-third">
			<p class="center">
				<a class="cn-button cn-button-large cn-background-blue cn-button-full" href="http://connections-pro.com/faq/"><span><?php _e( 'FAQs', 'connections' ); ?></span></a>
			</p>
		</div>
		...
		<div class="one-third">
			<p class="center">
				<a class="cn-button cn-button-large cn-background-blue cn-button-full" href="http://connections-pro.com/extensions/"><span><?php _e( 'Extensions', 'connections' ); ?></span></a>
			</p>
		</div>
		...
		<div class="one-third">
			<p class="center">
				<a class="cn-button cn-button-large cn-background-blue cn-button-full" href="http://connections-pro.com/templates/"><span><?php _e( 'Templates', 'connections' ); ?></span></a>
			</p>
		</div>
		...
		<div class="one-third">
			<p class="center">
				<a class="cn-button cn-button-large cn-background-blue cn-button-full" href="http://connections-pro.com/support/forum/bug-reports/"><span><?php _e( 'Bug Report', 'connections' ); ?></span></a>
			</p>
		</div>
		...
		<div class="one-third">
			<p class="center">
				<a class="cn-button cn-button-large cn-background-blue cn-button-full" href="http://connections-pro.com/support/forum/feature-requests/"><span><?php _e( 'Feature Request', 'connections' ); ?></span></a>
			</p>
		</div>
