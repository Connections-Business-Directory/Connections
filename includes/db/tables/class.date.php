...
use Connections\DB\Table\Column\Date as DateBased;
...
class Date extends Table {
	...
	public function __construct() {
		...
		if ( ! defined( 'CN_ENTRY_DATE_TABLE' ) ) {
			...
			define( 'CN_ENTRY_DATE_TABLE', $this->get_prefix() . $this->get_slug() );
		}
	}
	...
	public function get_table_name( \wpdb $wpdb ) {
		...
		return "{$this->get_prefix()}connections_date_ironbound";
	}
	...
	public function get_columns() {
		...
		return array(
			...
			'date'       => new DateBased( 'date', array( 'NOT NULL', 'DEFAULT \'0000-00-00\'' ), array() ),
