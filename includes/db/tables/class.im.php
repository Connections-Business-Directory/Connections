<?php
/**
 * Define the core instant messenger table.
 *
...
class IM extends Table {
	...
	public function __construct() {
		...
		if ( ! defined( 'CN_ENTRY_MESSENGER_TABLE' ) ) {
			...
			define( 'CN_ENTRY_MESSENGER_TABLE', $this->get_prefix() . $this->get_slug() );
		}
	}
	...
	public function get_table_name( \wpdb $wpdb ) {
		...
		return "{$this->get_prefix()}connections_messenger_ironbound";
	}
	...
	public function get_columns() {
		...
		return array(
			...
			'uid'        => new StringBased( 'TINYTEXT', 'uid', array( 'NOT NULL' ), array() ),
