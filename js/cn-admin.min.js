...
}else{tinyMCE.execCommand("mceAddControl",false,id);}});if(b.fn.datepicker){b(".datepicker").live("focus",function(){b(this).datepicker({changeMonth:true,changeYear:true,showOtherMonths:true,selectOtherMonths:true});
