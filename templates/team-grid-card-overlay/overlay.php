...
if ( ! class_exists( 'CN_Block_Team_Grid_Card_Overlay_Template' ) ) {
	...
	/**
	 * Class CN_Block_Team_Grid_Card_Overlay_Template
	 */
	class CN_Block_Team_Grid_Card_Overlay_Template {
		...
		public static function register() {
			...
			$atts = array(
				...
				'slug'        => 'block-team-grid-card-overlay',
				'type'        => 'block',
				'version'     => '1.0',
				'author'      => 'Steven A. Zahm',
...
HERE;
	...
	add_action( 'cn_register_template', array( 'CN_Block_Team_Grid_Card_Overlay_Template', 'register' ) );
}
