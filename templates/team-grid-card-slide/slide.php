...
if ( ! class_exists( 'CN_Block_Team_Grid_Card_Slide_Template' ) ) {

	/**
	 * Class CN_Block_Team_Grid_Card_Slide_Template
	 */
	class CN_Block_Team_Grid_Card_Slide_Template {
		...
		public static function register() {
			...
			$atts = array(
				'class'       => __CLASS__,
				'name'        => 'Block: Team Block Grid Card Slide',
				'slug'        => 'block-team-grid-card-slide',
				'type'        => 'block',
				'version'     => '1.0',
				'author'      => 'Steven A. Zahm',
...
HERE;
	...
	add_action( 'cn_register_template', array( 'CN_Block_Team_Grid_Card_Slide_Template', 'register' ) );
}
